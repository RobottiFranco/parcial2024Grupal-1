...
public class ManejadorArchivosGenerico {
     ...
     * Si el archivo no existe, se crea; si ya existe, se escribe al final del
     * mismo.
     *
     * @param nombreCompletoArchivo Ruta completa del archivo a escribir.
     * @param listaLineasArchivo    Arreglo de cadenas de texto con las líneas a
    ...
    /**
     * Lee un archivo de texto y retorna su contenido en forma de un arreglo de
     * líneas.
     *
