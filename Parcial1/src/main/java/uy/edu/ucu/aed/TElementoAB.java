...
public class TElementoAB<T> implements IElementoAB<T> {
    ...
    public int lti(int nivel) {
        ...
        int ltiDerecho = 0;
        if (this.getHijoIzq() != null) {
            ltiIzquierdo = this.getHijoIzq().lti(nivel + 1);
        }
        if (this.getHijoDer() != null) {
            ltiDerecho = this.getHijoDer().lti(nivel + 1);
        }
        return nivel + ltiIzquierdo + ltiDerecho;
    }

    public void ltim(int[] array, int nivel) {

        array[0] += 1;
        array[1] += nivel;

        if (this.getHijoIzq() != null) {
            this.getHijoIzq().ltim(array, nivel + 1);
        }
        if (this.getHijoDer() != null) {
            this.getHijoDer().ltim(array, nivel + 1);
        }
